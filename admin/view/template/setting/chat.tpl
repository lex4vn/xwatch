    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-chat-online"><?php echo $entry_chat_online; ?></label>
            <div class="col-sm-10">
                <textarea name="config_chat_online" placeholder="<?php echo $help_chat_online; ?>" rows="15" id="input-chat-online" class="form-control"><?php echo $config_chat_online; ?></textarea>
            </div>
        </div>
        </form>
      </div>
