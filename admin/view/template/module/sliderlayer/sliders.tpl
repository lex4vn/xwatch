	...
	<div id="page-content" class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
                ...
                <a href="https://docs.google.com/document/d/1w7xOzDwPqOEfOuTo3A-QlSx6Ht89pNKg3SIBkU2w9Oo/edit?usp=sharing" target="_blank"><span class="help" title="Hướng dẫn sử dụng"><i class="fa fa-question"></i></span></a>
			</div>
						...
						<div class="groups">
							...
							<ul>
								...
								<li <?php if( $sgroup['id'] == $id ) { ?> class="active" <?php } ?> >    
									<a class="text-warning" title="Edit Sliders In Group" href="<?php echo  $objurl->link('module/pavsliderlayer/layer', 'group_id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>"  >
										<i class="fa fa-list-alt"></i>  | </a>
										 
									<a title="Edit This Group" <?php if( $sgroup['id'] == $id ) { ?> class="btn-edit-group active" <?php } ?> href="<?php echo $objurl->link('module/pavsliderlayer', 'id='.$sgroup['id'].'&token=' . $objsession->data['token'], 'SSL');?>">
													...
													<tr>
														...
														<td>
															...
															<div class="buttons">
																...
																<a class="btn btn-primary btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/layer', 'group_id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>" class="btn btn-green" >
																	<i class="fa fa-list-alt fa-2x"></i><br>
																	<?php echo 'Manages Sliders'; ?></a>
																

																		
																<a class="btn btn-warning btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/export', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>"  class="btn orange" id="preview-sliders">
																	<i class="fa fa-floppy-o fa-2x"></i><br>
																	<?php echo $objlang->get('Export Group And Sliders'); ?></a>

																	<p class="pull-right">
																		<a class="btn btn-success btn-sm" id="btn-preview-ingroup" href="<?php echo  $objurl->link('module/pavsliderlayer/previewGroup', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>" class="button grey" id="preview">
																	<i class="fa fa-play fa-2x"></i><br>
																	<?php echo $objlang->get('Preview Sliders In Group');?>
																	</a>
																	<a class="btn btn-danger btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/deleteGroup', 'id='.$id.'&token=' . $token, 'SSL');?>" onclick="return confirm('Are you sure to delete this');" class="btn " id="preview-sliders">
