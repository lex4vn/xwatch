<?php
 ...
 ?>
 <div class="product-block item-default item-default-action-inner" itemtype="http://schema.org/Product" itemscope>
    
    <div class="block-img">
        <?php if ($product['thumb']) {    ?>
            <?php if( $product['special'] ) {   ?>
            <span class="product-label sale">
                <span class="product-label-special"><?php echo $this->language->get( 'text_sale' ); ?></span>
            </span>
        <?php } ?>
         ...
         <div class="action">
             <div class="quick-view">
                 ...
                 <?php if ( isset($quickview) && $quickview ) { ?>
                     <a data-toggle="tooltip" data-placement="top" title="<?php echo $this->language->get('quick_view'); ?>" class="pav-colorbox btn btn-default btn-inverse" href="<?php echo $this->url->link("themecontrol/product",'product_id='.$product['product_id'] );?>">
                        <i class="fa fa-eye"></i>
             ...
             <div class="wishlist">
                <a data-toggle="tooltip" data-placement="top" onclick="addToWishList('<?php echo $product['product_id']; ?>');" title="<?php echo $this->language->get("button_wishlist"); ?>" class="btn btn-default btn-inverse">
                <i class="fa fa-heart"></i>
                </a>
            </div>

            <div class="compare">
                <a data-toggle="tooltip" data-placement="top" title="<?php echo $this->language->get("button_compare"); ?>" class="btn btn-default btn-inverse" onclick="addToCompare('<?php echo $product['product_id']; ?>');">
    ...
    <?php if( !isset($listingConfig['catalog_mode']) || !$listingConfig['catalog_mode'] ) { ?>
     <div class="cart">
         <button onclick="addToCart('<?php echo $product['product_id']; ?>');" class="btn btn-default btn-inverse">
