		...
		<div class="box-products slide" id="pavdeals<?php echo $id;?>">
			<?php if( count($products) > $itemsperpage ) { ?>
				<div class="carousel-controls carousel-controls-v3">
					<a class="carousel-control left carousel-sm" href="#pavdeals<?php echo $id;?>"   data-slide="prev"><i class="md md-arrow-back"></i></a>
					<a class="carousel-control right carousel-sm" href="#pavdeals<?php echo $id;?>"  data-slide="next"><i class="md md-arrow-forward"></i></a>
				</div> 
