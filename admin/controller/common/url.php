<?php
class ControllerCommonUrl extends Controller {
		
	function changeAlias()
	{
		$json ='';
		if (isset($this->request->get['title'])) {
			$alias = $this->request->get['title'];
		    $alias = preg_replace('/[\x{0300}\x{0301}\x{0303}\x{0309}\x{0323}]/u', '', $alias); // fix unicode consortium for Vietnamese
		    $search = array( '&amp;', '&#039;', '&quot;', '&lt;', '&gt;', '&#x005C;', '&#x002F;', '&#40;', '&#41;', '&#42;', '&#91;', '&#93;', '&#33;', '&#x3D;', '&#x23;', '&#x25;', '&#x5E;', '&#x3A;', '&#x7B;', '&#x7D;', '&#x60;', '&#x7E;' );
		    $alias = preg_replace(array( '/[^a-zA-Z0-9]/', '/[ ]+/', '/^[\-]+/', '/[\-]+$/' ), array( ' ', '-', '', '' ), str_replace($search, ' ', $this->encString($alias)));
		    $json = strtolower($alias);
		}
		

		// $json = array(
		// 	'title' => $this->request->get['title'],
		// 	'url'   => strtolower($alias)
		// );
