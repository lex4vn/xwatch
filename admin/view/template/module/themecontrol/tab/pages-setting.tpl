											...
											<div class="col-sm-10">
												<ul class="nav nav-tabs nav-tablangs">
											  	<?php foreach ($languages as $language) { ?>
											  		<li><a href="#tab-lang-product-customhtml<?php echo $language['language_id'];?>" role="tab" data-toggle="tab">
											  			<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></a>
											  		</li>
											  	<?php } ?>
											  	</ul>
