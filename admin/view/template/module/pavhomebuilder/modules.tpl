		       									...
		       									<div class="mod-items">
		       									  <?php foreach( $ext['module'] as $emod ){ ?>
		       									  	<div class="mod-item wpo-ijwidget" data-module="<?php echo $emod['code'] ; ?>" data-type="module" data-name="<?php echo $emod['name'];?>">
			       									  	...
			       									  	<div title="Edit" data-href="<?php echo $ourl->link('module/'.$key,'module_id='.$emod['id'].'&token='.$token);?>" data-module="<?php echo $key; ?>" data-placement="top"  class="wpo-wedit ptstooltip"></div>
